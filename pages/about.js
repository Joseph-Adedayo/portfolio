            ...
            <main className="hide-scrollbar font-gilroysemibold">
                <AnimatePresence>
                    {isNavVisible && (
                        ...
                        >
                            <nav className={`md:text-white ${showElement ? "bg-white text-black py-5 shadow-xl" : ""}`}>
                                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2 px-10">
                                    <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse font-gilroysemibold text-3xl">
                                        {currentText}
                                    </a>
                                    <button
                                    ...
                                    <div className="w-full hidden md:block md:w-auto" id="navbar-default">
                                        <ul className="font-medium items-center text-xl text-black md:text-white justify-center flex flex-col p-4 md:p-0 mt-4 rounded-lg md:flex-row md:space-x-1 rtl:space-x-reverse md:mt-0 md:border-0">
                                            ...
                                            <li>
                                                <a href="mailto:yemi200237@gmail.com" className="block py-2 px-3">Contact</a>
                                            </li>
                                            <li>
                                                <a href="https://github.com/Joseph-Adedayo">
                                                    <svg fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72" className="cursor-pointer py-2 w-8">
                                            ...
                                            <li>
                                                <a href="https://www.joeuroedits.com/">
                                                    <img src={"/J0€_Edits_Logo_Transper1.png"} alt="J0€ Edits Logo" width={40} height={50} className="md:ml-3 py-2" />
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        {showElement && (
                                            ...
                                            >
                                                <ul className="font-medium items-center text-xl text-black md:text-white justify-center flex flex-col p-4 md:p-0 mt-1 rounded-lg md:flex-row md:space-x-1 rtl:space-x-reverse md:mt-0 md:border-0">
                                                    ...
                                                    <li>
                                                        <a href="https://github.com/Joseph-Adedayo">
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72" className="cursor-pointer py-2 w-8">
                                                    ...
                                                    <li>
                                                        <a href="https://www.joeuroedits.com/">
                                                            <img src={"/J0€_Edits_Logo_Transper1black.png"} alt="J0€ Edits Logo" width={50} height={60} className="md:ml-3 py-2" />
                                                        </a>
                                                    </li>
                                                </ul>
                                            </motion.div>
                ...
                >
                    <div className="mb-8 flex justify-center">
                        <div className="relative animate-pulse rounded-full px-3 py-1 text-xs md:text-sm font-gilroyregular text-center leading-6 text-white ring-1 ring-gray-100/20 hover:ring-gray-900/90">
                            ...
                            <a href="https://www.joeuroedits.com/" className="font-semibold text-slate font-gilroyextrabold">
                    ...
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-lg leading-8 font-gilroyregular">
                            This is my personal website where I share my thoughts, ideas and projects.
                        </p>
                    </div>
                </motion.div>
            </div>
                ...
                <div className="grid items-center grid-cols-1 md:grid-cols-2">
                    <div className="px-10">
                        ...
                        <p className="mt-4 text-xl text-gray-600 dark:text-gray-300 md:mt-8">
                            ...
                            <a href="https://www.linkedin.com/in/joseph-adedayo-559564238/" title="" className="transition-all duration-200 text-sky-600 hover:underline">
                                LinkedIn
                            </a>
                        </p>
                    </div>
...
const Testimonials = () => {
    ...
    return (
        <div className="container mx-auto py-5 md:py-12 pt-20 px-14 md:px-10" ref={inViewRef}>
            <motion.div
                ref={ref}
                variants={container}
                initial="hidden"
            ...
            >
                {testimonials.map((testimonial) => (
                    ...
                    >
                        ...
                        <p className="text-white text-xs text-center mb-1 font-gilroyregular">{testimonial.quote}</p>
                        {stars}
                        <div className="flex items-center space-x-4">
                            <div className="text-center">
                                <p className="font-gilroyextrabold text-gray-300">{testimonial.name}</p>
                                <p className="font-gilroyregular text-gray-400">{testimonial.title}</p>
                            </div>
                        </div>
                    </motion.div>
                ))}
...
const Projects = ({ setIsNavVisible }) => {
    ...
    return (
        <div id="Projects" ref={ref} className="mx-auto px-5 py-4 md:py-12 md:px-0">
            <h1 className="text-5xl md:text-3xl font-gilroysemibold leading-tight text-black dark:text-white mt-20 sm:text-4xl lg:text-5xl">
                Projects
            </h1>
            ...
            <div className="pt-10 rounded-lg shadow-lg">
                ...
                <div className="mt-4 gap-2 flex items-center">
                    {project.tech.map((tech) => (
                        <img key={tech} src={techIcons[tech]} alt={tech} className="w-6 h-6 mr-2" />
                    ))}
                </div>
                <p className="mt-4 text-xl font-gilroyregular text-gray-300">{project.desc}</p>
                <div className="mt-4 gap-4 flex items-center">
                    ...
                    {project.code.length > 0 && (
                        <a href={project.code}>
                            <CodeBracketIcon className="w-6 h-6 text-blue-500 dark:text-blue-400 hover:text-blue-600" />
                        </a>
                    )}
                </div>
            </div>
